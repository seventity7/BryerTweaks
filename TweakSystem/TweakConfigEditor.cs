...
public static class TweakConfigEditor {
    ...
    public static bool ColorEditor(string name, ref object configOption) {
        switch (configOption) {
            case Vector4 v4 when ImGui.ColorEdit4(name, ref v4, ImGuiColorEditFlags.NoInputs | ImGuiColorEditFlags.AlphaPreviewHalf | ImGuiColorEditFlags.AlphaBar):
                configOption = v4;
                return true;
            case Vector3 v3 when ImGui.ColorEdit3(name, ref v3, ImGuiColorEditFlags.NoInputs):
                configOption = v3;
                return true;
            default:
                return false;
