...
namespace BryerTweaks {
    public partial class BryerTweaksConfig {
        public DebugConfig Debugging = new DebugConfig();
    }
}

namespace BryerTweaks.Debugging {
    ...
    public abstract class DebugHelper : IDisposable {
        public BryerTweaks Plugin = null!;
