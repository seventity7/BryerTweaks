...
public sealed class FateMaidenOverlayRenderer {
    ...
    private const string MaidenOverlayName = "Maiden Forlon";
    ...
    public FateMaidenOverlayRenderer(IObjectTable objectTable, IGameGui gameGui) {
    ...
    public void Draw(bool overlayEnabled, float hideDistance) {
        ...
        var effectiveHideDistance = Math.Clamp(hideDistance, FateMaidenAlert.MinTrackerDistance, FateMaidenAlert.MaxTrackerDistance);
    ...
    private void DrawIcon(ImDrawListPtr drawList, uint iconId, Vector2 center, Vector2 size, float opacity) {
        ...
        drawList.AddCircleFilled(center, size.X * 0.45f, color, 28);
    }
